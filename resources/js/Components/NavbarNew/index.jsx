...
const NavbarNew = (props) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-center items-center gap-x-4 md:order-2">
                ...
                <div
                    id="shopping-cart"
                    className="hover:bg-primary transition duration-200 text-white-primary rounded-full p-2"
                >
                    <span>
                        <svg
                            width="24"
            ...
            {location == url && (
                <Navbar.Collapse>
                    <Navbar.Link className="md:font-semibold" active>
                        <Link href="/" as="button">
                            Beranda
                        </Link>
                    </Navbar.Link>
                    <Navbar.Link className="md:font-semibold" href="#aboutUs">
                        Tentang
                    </Navbar.Link>
                    <Navbar.Link className="md:font-semibold" href="#layanan">
                        Layanan
                    </Navbar.Link>
                    <Navbar.Link className="md:font-semibold" href="#kontak">
                        Kontak
                    </Navbar.Link>
                    <Navbar.Link className="md:font-semibold">
            ...
            {/* Shopping Cart Start */}
            <div className="absolute top-full right-0 w-[30rem] h-screen px-5 bg-white-primary">
                <div className="">
                    <img src="/img/gambar1.png" alt="Product 1" />
                    <div>
                        <h3>Produk 1</h3>
                        <p>Rp 30.000</p>
                    </div>
